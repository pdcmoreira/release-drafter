...
module.exports.findReleases = async ({ app, context, targetBranch }) => {
  ...
  if (targetBranch) {
    releases = releases.filter(r => r.target_commitish === targetBranch)
  }
...
module.exports.generateReleaseInfo = ({
  ...
  // Use the first imperative parameter to identify
